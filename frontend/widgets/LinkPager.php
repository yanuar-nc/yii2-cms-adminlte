...
/**
 * 
 * @copyright Justin Voelker <justin@justinvoelker.com> 2015
 *  
 */
class LinkPager extends \foundationize\foundation\LinkPager
{
    ...
    /**
     * @var  string        class name for ellipsis
     */
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        {
            Html::addCssClass($options, $this->ellipsisClass);
            return Html::tag('li', null, $options);
        }
        ...
        return Html::tag('li', $createUrl === false ? $label : Html::a($label, $this->pagination->createUrl($page), $linkOptions), $options);
    }
}